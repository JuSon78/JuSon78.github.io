<header>
    ...
    $actual_link = str_replace("http://localhost:8888/Pages/Connexion/", "", "http://$_SERVER[HTTP_HOST]$_SERVER[REQUEST_URI]");
    if($actual_link == "Invitation_Amis.php"){
        echo "<ul id=\"menu_header\">
            <li><a class=\"element_menu\" href='Accueil.php'><span>Accueil</span></a></li>
            <li><span class=\"element_menu_active\">Ajouter un ami</span></a></li>
        ...
        echo "<ul id=\"menu_header\">
            <li><a class=\"element_menu\" href='Accueil.php'><span>Accueil</span></a></li>
            <li><a class=\"element_menu\" href='Invitation_Amis.php'><span>Ajouter un ami</span></a></li>
